...
export const startKakaoLogin = (req, res) => {
  ...
  const urlConfig = {
    ...
    redirect_uri: 'http://bangba.site:4000/users/kakao/oauth',
    response_type: 'code',
...
export const startGoogleLogin = (req, res) => {
  ...
  const urlConfig = {
    ...
    redirect_uri: 'http://bangba.site:4000/users/google/oauth',
    response_type: 'code',
    scope:
...
export const startNaverLogin = (req, res) => {
  ...
  const urlConfig = {
    ...
    redirect_uri: 'http://bangba.site:4000/users/naver/oauth',
